...
function CountDown() {
for (var i = 0;i < 10;i++) {
	setTimeout(function() {Score.innerHTML = parseInt(Score.innerHTML) - 5	},i*(parseInt(Score.value)/4))
}
}

function CountUp() {
for (var i = 0;i < 10;i++) {
	setTimeout(function() {Score.innerHTML = parseInt(Score.innerHTML) + 1},i*(parseInt(Score.value)/4))
}
}
